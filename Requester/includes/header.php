...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top bg-danger flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="RequesterProfile.php">Mr.Repairman</a>
  <span class="navbar-text">We always ready</span>
    ...
    <div class="collapse navbar-collapse" id="myMenu">
      <ul class="navbar-nav pl-5 custom-nav">
        <li class="nav-item"><a href="RequesterProfile.php" class="nav-link">Dashboard</a></li>
        <li class="nav-item"><a href="servicecategory.php" class="nav-link">Service Category</a></li>
