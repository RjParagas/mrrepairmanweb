...
<body>
  ...
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span>USER CLIENT</span>
  </p>
      ...
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4" method="POST">
          <div class="form-group">
            ...
            <small class="form-text">We'll never share your email with anyone else. baka pag open mo bakla ka na </small>
          </div>
          <div class="form-group">
